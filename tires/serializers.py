...
class TiresidSerializer(serializers.ModelSerializer):
    ...
    def get_width(self, obj):
        return obj.width.title if obj.width else None

    def get_profile(self, obj):
        return obj.profile.title if obj.profile else None

    def get_diameter(self, obj):
        return obj.diameter.title if obj.diameter else None
    ...
    def get_car_type(self, obj):
        return obj.car_type.title if obj.car_type else None

    def get_seasonality(self, obj):
        return obj.seasonality.title if obj.seasonality else None

    def get_state(self, obj):
        return obj.state

    def get_manufacturer(self, obj):
        return obj.manufacturer.title if obj.manufacturer else None
    ...
    def get_speed_index(self, obj):
        return obj.speed_index.title if obj.speed_index else None

    def get_load_index(self, obj):
        return obj.load_index.title if obj.load_index else None

    def get_fuel_economy(self, obj):
        return obj.fuel_economy.title if obj.fuel_economy else None

    def get_grip_on_wet_surfaces(self, obj):
        return obj.grip_on_wet_surfaces.title if obj.grip_on_wet_surfaces else None

    def get_external_noise_level(self, obj):
        return obj.external_noise_level.title if obj.external_noise_level else None
    ...
    def get_model(self, obj):
        return obj.model.title if obj.model else None

    def get_load_index_for_dual(self, obj):
        return obj.load_index_for_dual.title if obj.load_index_for_dual else None
